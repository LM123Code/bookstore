...
<div id="divmenu">
	...
	<a
		href="${pageContext.request.contextPath}/showProductByPageServlet?category=经营">经管</a>
	<a
	...
	<a
		href="${pageContext.request.contextPath}/showProductByPageServlet?category=学术">学术</a>
	<a
	...
	<a href="${pageContext.request.contextPath}/showProductByPageServlet" style="color:#FFFF00">全部商品目录</a>
</div>
<div id="divsearch">
